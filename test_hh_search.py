...
Я заметил что иногда ты пишешь в конце меня как Санья или Сания. Не делай так. Меня зовут Александр
...
def test_hh():
    with sync_playwright() as p:
        ...
        while True:
            ...
            new_vacancy_btn = page.locator('[data-qa="autosearch__results-counter_new"]').last
